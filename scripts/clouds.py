...
class Clouds:
    def __init__(self, cloud_images, count=16):
        ...
        # Generate clouds of random position, specific images, animation speed, and depth rendering order
        ...
        # Sorting clouds based on depth, so we draw in the correct order
